...
//ol.proj.get("EPSG:7755").setExtent([4562003.562923, 3745255.195307, 4992616.991999, 4380809.548869]);
var wms_layers = [];
...
var format_WB_Gram_Panchayat_1 = new ol.format.GeoJSON();
var features_WB_Gram_Panchayat_1 = format_WB_Gram_Panchayat_1.readFeatures(json_WB_Gram_Panchayat_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:7755'});
var jsonSource_WB_Gram_Panchayat_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_WB_Gram_Panchayat_1.addFeatures(features_WB_Gram_Panchayat_1);
var lyr_WB_Gram_Panchayat_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_WB_Gram_Panchayat_1,
maxResolution:112.01786460904783,
 
                style: style_WB_Gram_Panchayat_1,
                popuplayertitle: 'WB_Gram_Panchayat',
                interactive: true,
                title: '<img src="styles/legend/WB_Gram_Panchayat_1.png" /> WB_Gram_Panchayat'
            });
...
lyr_OpenStreetMap_0.setVisible(true);lyr_WB_Gram_Panchayat_1.setVisible(true);lyr_WB_Block_Boundary_2.setVisible(true);lyr_WB_District_Boundary_3.setVisible(true);lyr_Rural_other_than_sc_4.setVisible(true);lyr_Rural_SC_5.setVisible(true);lyr_Urban_6.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_WB_Gram_Panchayat_1,lyr_WB_Block_Boundary_2,lyr_WB_District_Boundary_3,lyr_Rural_other_than_sc_4,lyr_Rural_SC_5,lyr_Urban_6];
lyr_WB_Gram_Panchayat_1.set('fieldAliases', {'GP_NAME': 'GP_NAME', 'townname': 'townname', 'towncensus': 'towncensus', 'town_lgd_c': 'town_lgd_c', 'ward_lgd_c': 'ward_lgd_c', 'ward_lgd_n': 'ward_lgd_n', 'sourcewa_1': 'sourcewa_1', 'MUNI_NAME': 'MUNI_NAME', 'BLOCK_NAME': 'BLOCK_NAME', 'SUBDIV_NAM': 'SUBDIV_NAM', 'DIST_NAME': 'DIST_NAME', 'STATE': 'STATE', 'MOUZA_COUN': 'MOUZA_COUN', 'AC_NO': 'AC_NO', 'AC_NAME': 'AC_NAME', 'PC_NO': 'PC_NO', 'PC_NAME': 'PC_NAME', 'xyz': 'xyz', 'styleidx': 'styleidx', 'Area_sq_km': 'Area_sq_km', });
...
lyr_WB_Gram_Panchayat_1.set('fieldImages', {'GP_NAME': 'TextEdit', 'townname': 'TextEdit', 'towncensus': 'TextEdit', 'town_lgd_c': 'Range', 'ward_lgd_c': 'Range', 'ward_lgd_n': 'TextEdit', 'sourcewa_1': 'TextEdit', 'MUNI_NAME': 'TextEdit', 'BLOCK_NAME': 'TextEdit', 'SUBDIV_NAM': 'TextEdit', 'DIST_NAME': 'TextEdit', 'STATE': 'TextEdit', 'MOUZA_COUN': 'Range', 'AC_NO': 'Range', 'AC_NAME': 'TextEdit', 'PC_NO': 'Range', 'PC_NAME': 'TextEdit', 'xyz': 'TextEdit', 'styleidx': 'Range', 'Area_sq_km': 'TextEdit', });
...
lyr_WB_Gram_Panchayat_1.set('fieldLabels', {'GP_NAME': 'no label', 'townname': 'no label', 'towncensus': 'no label', 'town_lgd_c': 'no label', 'ward_lgd_c': 'no label', 'ward_lgd_n': 'no label', 'sourcewa_1': 'no label', 'MUNI_NAME': 'no label', 'BLOCK_NAME': 'no label', 'SUBDIV_NAM': 'no label', 'DIST_NAME': 'no label', 'STATE': 'no label', 'MOUZA_COUN': 'no label', 'AC_NO': 'no label', 'AC_NAME': 'no label', 'PC_NO': 'no label', 'PC_NAME': 'no label', 'xyz': 'no label', 'styleidx': 'no label', 'Area_sq_km': 'no label', });
